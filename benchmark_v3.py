#!/usr/bin/env python3
"""
Benchmark v3 — uses compliance_scorer_v3.py (new prompt).

Saves results to benchmark_results_v3_<model>.json.
...
from compliance_scorer_v3 import score_documents, PROMPT_VERSION
